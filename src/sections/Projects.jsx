...
const Projects = () => {
  return (
    ...
    <div className="grid md:grid-cols-3 gap-10 text-gray-100">
        {/* Project 1 */}
        <div className="bg-neutral-800 p-5 rounded-2xl shadow-lg hover:shadow-purple-500/50 transition">
            ...
            <p className="mb-4 text-xl">Modern responsive website for buying clothes with booking features</p>
        ...
        {/* Project 2 */}
        <div className="bg-neutral-800 p-5 rounded-2xl shadow-lg hover:shadow-green-500/50 transition">
        <div className="aspect-video rounded-lg overflow-hidden mb-4">
            <iframe 
        ...
        <h3 className="text-xl font-semibold mb-2">💇 Hair By Zee</h3>
        <p className="mb-4">Modern responsive website for a hair salon with booking features</p>
        ...
        <div className="aspect-video rounded-lg overflow-hidden mb-4">
            <iframe 
            src="https://your-coffee-site-url.com" 
            title="Coffee Website" 
            className="w-full h-full border-none"
            ></iframe>
        </div>
        <h3 className="text-xl font-semibold mb-2">☕ Coffee Website</h3>
        <p className="mb-4">Modern responsive website for a coffee shop with booking features</p>
        <div className="flex gap-2 text-gray-400">
            <span className="text-sm">HTML</span>
            <span className="text-sm">CSS</span>
            <span className="text-sm">JS</span>
